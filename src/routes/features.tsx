...
const sections: FeatureSection[] = [
  ...
  },
  {
    ...
    body: "Surface items that need attention while there is still time to act. Each card shows how long it has been low, and whether an RFQ or order is already underway.",
    bullets: [
      "Low-stock lists ready for action",
      "Linked RFQs and orders on each item",
